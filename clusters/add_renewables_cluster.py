    ...
    for node in nodes_with_clusters.copy():
        ...
        for renewable in renewables:
            ...
            for idx in clusters_generators[(node, renewable)].index:
                ...
                bus_name=f"{clusters_generators[(node, renewable)].loc[idx].bus + ' cluster'}$"
                ...
                if bus_name not in n.buses.index:
                    ...
                    print(f"Bus {clusters_generators[(node, renewable)].loc[idx].bus + ' cluster'} already exists in the network.")
